...
type CommittedSpendTrendProps = CommittedSpendTrendOwnProps & WrappedComponentProps;

const CommittedSpendTrendBase: React.SFC<CommittedSpendTrendProps> = ({ formatOptions = {}, intl, report }) => {
...
const CommittedSpendTrend = injectIntl(CommittedSpendTrendBase);
