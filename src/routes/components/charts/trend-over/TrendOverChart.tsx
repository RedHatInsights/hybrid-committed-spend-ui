...
interface TrendOverChartOwnProps {
...
type TrendOverChartProps = TrendOverChartOwnProps & WrappedComponentProps;

const TrendOverChartBase: React.FC<TrendOverChartProps> = ({
...
const TrendOverChart = injectIntl(TrendOverChartBase);

export { TrendOverChart, TrendOverChartProps };
